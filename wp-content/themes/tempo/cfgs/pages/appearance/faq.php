			...
			'tempo-faq' => array(
			    ...
			    'sections' 	=> array(
					...
					'zeon' => array(
						...
						'description'	=> sprintf( __( 'Activate premium features and get extended core functionality without the risk of loosing any data or settings %1$s with our %2$s that upgrades our Tempo WordPress theme.', 'tempo' ) , '<br/>', '<a href="' . esc_url( tempo_core::theme( 'premium-link' ) ) . '" title="' . esc_attr( sprintf( __( '%1$s - Upgrade %2$s to Premium', 'tempo' ), tempo_core::author( 'name' ), tempo_core::theme( 'Name' ) ) )  . '" target="_blank">' . __( 'Tempo Premium Solution', 'tempo' ) . '</a>' ),
						'template'  	=> 'templates/admin/appearance/faq/premium'
					),
					'support' => array(
						'title' 		=> __( 'Support and Feadback', 'tempo' ),
						'description'	=> sprintf( __( 'If you have questions about the theme or the theme features then you are welcome to use our forum.%1$s Also if you found bugs please provide us a feedback.', 'tempo' ), '<br/>' ),
